            ...
            <section className="text-gray-600 body-font">
                <div className="container mx-auto flex md:px-5 px-1 md:py-24 py-10 md:flex-row flex-col items-center">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24  md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        ...
                        <p className="mb-8 leading-relaxed md:text-md">Hi, my name is Ashok, a full stack developer who likes creating websites like his coffee.
                    ...
                    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-full px-3">
                        <img className="object-cover object-center md:rounded-xl rounded" alt="hero" src="mypic20.jpg" />
                    </div>
                </div>
            </section>
