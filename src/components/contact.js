        ...
        <div className="flex md:flex-row flex-col mt-[5rem] bg-slate-800 text-white md:p-8 p-5" id="contact"  >
            <div className="md:basis-1/2 basis-1">
                ...
                <div className="grid grid-flow-col md:mt-[3rem] mt-[2rem] text-4xl md:w-1/4 w-full">
                   {/* <GrLinkedinOption/> */}
                   <a href="https://www.instagram.com/a100k_choudhary_/" target="_blank" className="hover:text-rose-200">
                   <BsInstagram/></a>
                   <a href="https://t.me/ashok01" target="_blank" className="hover:text-rose-200">
                   <FaTelegramPlane/></a>
